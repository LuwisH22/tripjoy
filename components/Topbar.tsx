          ...
          <AnimatePresence>
            {bellOpen && (
              <motion.div
                ...
                className="fixed right-4 top-16 z-50 w-72 max-w-[calc(100vw-2rem)] origin-top-right rounded-2xl border border-line bg-white p-3 shadow-float sm:absolute sm:right-0 sm:top-14 sm:z-30"
              >
